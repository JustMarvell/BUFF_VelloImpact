...
async def setup(bot : commands.Bot):
    await bot.add_command(CharacterControllers(bot))

class CharacterControllers(commands.Bot):
    ...
    async def get_character_id(self, char_name : str):
    ...
    async def check_character(self, char_name: str):
